...
/* 
1. Configure Your WS's Base Url
Set the base url for your WS's gateway
*/
export const partnerWsUrl = `ws://localhost:8080/mockExternal`;

/*
2. Configure Your WS Headers
If your WS requires any specific headers to be utilized, fill in the necessary params in the headers object
If your WS does not need any headers to be utilized, leave headers as an empty object, {}
*/
export const partnerWsHeaders = {
  WSKey: `partnerWsKey`,
};
export const wsPartnerName = "protocolName";
